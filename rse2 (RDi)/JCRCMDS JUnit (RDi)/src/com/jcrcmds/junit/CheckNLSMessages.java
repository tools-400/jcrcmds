...
public class CheckNLSMessages {
    ...
    public void testNLSMessages() throws Exception {
        ...
        checkMessagesForLocales(com.jcrcmds.base.Messages.class, "messages");
        checkMessagesForLocales(com.jcrcmds.base.rse.Messages.class, "messages");
        checkMessagesForLocales(com.jcrcmds.base.rse.Messages.class, "messages");
